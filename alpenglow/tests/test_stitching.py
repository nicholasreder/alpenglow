...
for z in range(1, 11):
    for number in intervals:
        ...
        image_invert = (skimage.filters.gaussian(camera_invert,
                                                 number)*255).astype('uint8')
        strip1 = image[50:200]
        ...
        strip1 = np.pad(strip1, ((0, 0), (0, 38)), 'constant',
                        constant_values=(0))

        strip2 = np.pad(strip2, ((0, 0), (38, 0)), 'constant',
                        constant_values=(0))
        strip3 = np.pad(strip3, ((0, 0), (19, 19)), 'constant',
                        constant_values=(0))
        strip1_invert = np.pad(strip1_invert, ((0, 0), (0, 38)), 'constant',
                               constant_values=(0))
        strip2_invert = np.pad(strip2_invert, ((0, 0), (38, 0)), 'constant',
                               constant_values=(0))
        strip3_invert = np.pad(strip3_invert, ((0, 0), (19, 19)), 'constant',
                               constant_values=(0))
